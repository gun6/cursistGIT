...
@ContextConfiguration(classes = { TestDataSourceConfig.class, TestRepositoriesConfig.class, ServicesConfig.class, ControllersConfig.class, RestControllersConfig.class, RestClientsConfig.class, MailConfig.class  })
@WebAppConfiguration 
@Transactional
