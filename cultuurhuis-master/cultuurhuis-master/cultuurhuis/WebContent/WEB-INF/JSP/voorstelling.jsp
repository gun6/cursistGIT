...
<body>
	...
	<%-- 	Vervolg uitleg over parameter "genre" vanuit VoorstellingServlet.java
			Hier wordt dus het request attribute gebruikt dat initieel vanuit menu.jsp kwam
	--%>
					...
					<tr class="${status.count % 2 == 0? 'even':'oneven'}">
						...
						<td>
							<c:if test="${voorstelling.vrijePlaatsen > 0}">
								<!-- 	samenstelling queryURL (/reservatie.htm?voorstellingId=27)
										deze wordt uitgelezen in ReservatieServlet
								-->
